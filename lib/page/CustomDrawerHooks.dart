...
class CustomDrawerHook extends HookWidget {
  final Widget child;
  final Widget drawer;

  CustomDrawerHook({Key key, this.child, this.drawer}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    _animationController = useAnimationController(duration: toggleDuration);
